<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Alumini.aspx.cs" Inherits="deedback.Admin.Alumini" %>
            ...
            <div class="box-body">
             ...
             <%-- <td> <button name="submit" type="submit" value="Submit" runat="server" onclick="approve<%# Eval("id") %>">Approve</button></td>--%>
                  ...
                  <%--<td> <input type="button" style="background:red;color:white" value="Reject" id="rej" runat="server"/></td>--%>
                     ...
                     <td><button type="button" id="btnEdit" class="btn btn-sm btn-primary" onclick="approve(<%# Eval("id") %>)"><i class="fas fa-eye"></i>Approve</button></td>
                    <td><button type="button"  style="background:red;color:white" id="btnEdit" class="btn btn-sm btn-primary" onclick="reject(<%# Eval("id") %>)"><i class="fas fa-eye"></i>Reject</button></td>
                 </tr>
...
<script>
    ...
    function approve(id) {
        window.location = "approve_product.aspx?id=" + id;
    }
    function reject(id) {
        window.location = "reject_product.aspx?id=" + id;
    }
</script>
      ...
      <script>
          function Active(id) {
              ...
              $.ajax({
                  ...
                  dataType: "json",
                  data: JSON.stringify({ JID: id }),
                  url: "tester.aspx/Active",
                  success: function (data) {
                      if (data.d == 1) {
                          window.location.href = "Alumini.aspx";
