<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="deedback.Admin.index" %>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6" style="display:none">
          ...
          <div class="small-box bg-red">
            ...
            <a href="funds_view.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
