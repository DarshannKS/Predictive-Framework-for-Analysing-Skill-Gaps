<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="alumini_meet.aspx.cs" Inherits="deedback.Admin.alumini_meet" %>
...
<head runat="server">
  ...
  <title>Admin|Alumini_meet</title>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
                ...
                <label>Tittle</label>
              <input type="text" class="form-control" id="title" runat="server" placeholder="Enter ...">
              </div>
            </div>
              <!-- /.form-group -->
             <div class="col-md-6">
           <div class="form-group">
                <label>Place</label>
              <input type="text" class="form-control" id="plc" runat="server" placeholder="Enter ...">
              </div>
            </div>
              <!-- /.form-group -->
              <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="mdate" runat="server" placeholder="Enter ...">
              </div>
             </div>

               <div class="col-md-6">
                <div class="form-group">
                <label>Meeting_deatails</label>
              ...
              <%--<input type="text" class="form-control" id="phno" runat="server" placeholder="Enter contact number...">--%>
                ...
                <button type="submit" class="btn btn-info pull-right" onserverclick="Unnamed_ServerClick" runat="server">Upload</button>
              </div>
            </div>
