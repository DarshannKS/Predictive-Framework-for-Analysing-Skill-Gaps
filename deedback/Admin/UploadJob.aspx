<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UploadJob.aspx.cs" Inherits="deedback.Admin.UploadJob" %>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>EduChamp</b>LTE</span>
    </a>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="Cname" runat="server" placeholder="Enter ...">
              </div>
              <!-- /.form-group -->
           <div class="form-group">
                <label>Company Email</label>
              <input type="text" class="form-control" id="Cemail" runat="server" placeholder="Enter ...">
              </div>
              <!-- /.form-group -->
            </div>
              ...
              <input type="text" class="form-control" id="phn" runat="server" placeholder="Enter ...">
              </div>
              <!-- /.form-group -->
           <div class="form-group">
                <label>Drive_In Date</label>
              <input type="text" class="form-control" id="clsDate" runat="server" placeholder="Enter ...">
              </div>
              <!-- /.form-group -->
            </div>
              ...
              <input type="text" class="form-control" id="JobTitle" runat="server" placeholder="Enter ...">
              </div>
              <!-- /.form-group -->
           <div class="form-group">
                <label>Skilles Required</label>
              <input type="text" class="form-control" id="Skilles" runat="server" placeholder="Enter ...">
              </div>
              <!-- /.form-group -->
                 ...
                 <div class="col-md-6">
              <div class="form-group">
                <label>Num of Post </label>
              <input type="text" class="form-control" id="Cavil" runat="server" placeholder="Enter ...">
              </div>
              <!-- /.form-group -->
           <div class="form-group">
                <label>Company Location</label>
              <input type="text" class="form-control" id="loc" runat="server" placeholder="Enter ...">
              </div>
              <!-- /.form-group -->
            </div>
            <!-- /.col -->
          ...
          <!-- /.row -->
                ...
                <button type="submit" class="btn btn-info pull-right" runat="server" onserverclick="Unnamed_ServerClick">Upload</button>
              </div>
               </form>
        <!-- /.box-body -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2018 <a target="_blank" href="">Templates Hub</a>.</strong> All rights
    reserved.
  </footer>
