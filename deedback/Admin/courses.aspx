<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="courses.aspx.cs" Inherits="deedback.Admin.courses" %>
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="Text1" runat="server" placeholder="Enter ...">
              </div>
            </div>
              <!-- /.form-group -->
             <div class="col-md-6">
           <div class="form-group">
              ...
              <input type="text" class="form-control" id="cdetails" runat="server" placeholder="Enter ...">
              </div>
            </div>
              <!-- /.form-group -->
              <div class="col-md-6">
                <div class="form-group">
                <label>Branch</label>
              <input type="text" class="form-control" id="branch" runat="server" placeholder="Enter ...">
              </div>
             </div>
                <div class="col-md-6">
                 <div class="form-group">
