<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Predict.aspx.cs" Inherits="deedback.Admin.Predict" %>
...
<asp:GridView 
    ...
    <Columns>
        <asp:BoundField DataField="CourseSem" HeaderText="Semester" />
        <asp:BoundField DataField="TotalMarks" HeaderText="Total Marks" DataFormatString="{0:F2}" />
        <asp:BoundField DataField="AvgMarks" HeaderText="Average Marks" DataFormatString="{0:F2}" />
        <asp:BoundField DataField="Recommendation" HeaderText="Suggested Path" />
    </Columns>
</asp:GridView>       
