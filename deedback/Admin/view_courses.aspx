<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_courses.aspx.cs" Inherits="deedback.Admin.view_courses" %>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
              <h3 class="box-title">Courses Data</h3>
            <div class="box-header">
              
                   <div class="col-xs-3">
      <a href="courses.aspx" class="btn btn-block btn-success">Add Courses</a>
                       </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
    ...
    <script>
               ...
               function ClaimDelete(id) {
                       ...
                       $.ajax({
                           ...
                           url: "view_courses.aspx/deleteClaim",
