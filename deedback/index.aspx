<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="deedback.index" %>
...
<div id="loading-icon-bx"></div>
		...
		<div class="sticky-header navbar-expand-lg">
            <div class="menu-bar clearfix">
                <div class="container clearfix">
					<!-- Header Logo ==== -->
					<div class="menu-logo">
						<a href="index.aspx"><img src="assets/images/logo-white.png" alt=""></a>
					</div>
					<!-- Mobile Nav Button ==== -->
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
                        ...
                        <ul class="nav navbar-nav">	
							<li class="active"><a href="index.aspx">Home</a>
								<li class="active"><a href="course.aspx">Courses</a>
								...
								<ul class="sub-menu">
									...
									<%--<li><a href="alumini.aspx">Alumini</a></li>--%>
							
									<li><a href="currnt_stud.aspx">Current_student </a></li>
									<li><a href="alumini.aspx">Alumini </a></li>
					...
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption Newspaper-Title   tp-resizeme" 
								...
								data-paddingleft="[0,0,0,0]"
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;color:white">
    ...
    <footer>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center"> <a target="_blank" href="">BGS 2025</a></div>
                </div>
            </div>
        </div>
    </footer>
