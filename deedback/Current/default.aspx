<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="deedback.Current._default" %>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    <h3>
                                        <asp:Label ID="Label1" runat="server" Text="Label">0</asp:Label></h3>
                                ...
                                <a href="viewdrive.aspx" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
...
<zapier-interfaces-chatbot-embed is-popup='true' chatbot-id='cm8wrxw37000lqld7bpq08bzf'></zapier-interfaces-chatbot-embed>
    <footer class="main-footer">
        <div class="pull-right hidden-xs">
            <b>Version</b> 2.4.0
        </div>
        <strong>Copyright &copy; 2021-2022 <a target="_blank" href="">Code Red</a>.</strong> All rights
    reserved.
    </footer>
