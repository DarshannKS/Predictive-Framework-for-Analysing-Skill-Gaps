<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Prediction.aspx.cs" Inherits="deedback.Current.Prediction" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="styled-grid">
    <Columns>
        <asp:BoundField DataField="StdUSN" HeaderText="USN" />
        ...
        <asp:BoundField DataField="Recommendation" HeaderText="Suggestion" />
    </Columns>
</asp:GridView>    
                                <br />
                                <br />
