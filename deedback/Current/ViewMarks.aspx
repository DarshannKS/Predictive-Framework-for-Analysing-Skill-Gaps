<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewMarks.aspx.cs" Inherits="deedback.Current.ViewMarks" %>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
                   ...
                   <div class="col-xs-3">
      <a href="addMarks.aspx" class="btn btn-block btn-success">Add Marks</a>
                       </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
               ...
               <%--   <th>Email</th>--%>
                ...
                <tr>
                 ...
                 <%-- <td><%# Eval("Cemail") %></td>--%>
                  <td><%# Eval("CourseSem") %></td>
                  <td><%# Eval("marks") %></td>
                  <td><a href='../upload/<%# Eval("File") %>' target="_blank">Marks Card</a></td>
                  <%--<td><%# Eval("Cost") %></td>
    ...
    <script>
               ...
               function ClaimDelete(id) {
                       ...
                       $.ajax({
                           ...
                           url: "viewMarks.aspx/deleteClaim",
