<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addMarks.aspx.cs" Inherits="deedback.Current.addMarks" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="Text1" runat="server">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>SGPA</label>
                                        <input type="text" class="form-control" id="sgpa" runat="server" placeholder="Enter ...">
                                    </div>
                                </div>
                                <!-- /.form-group -->
