...
namespace deedback
{
    public partial class currnt_stud : System.Web.UI.Page
    {
        ...
        protected void Unnamed_ServerClick1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    MailMessage m = new MailMessage("secureimg1@gmail.com", email.Value, "Welcome Mail !!!", "​Welcome to the College Application !!!\n Your User  name : " + uname.Value + "\n Your Password is: " + pswd.Value + "");
